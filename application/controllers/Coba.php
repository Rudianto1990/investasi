...
class Coba extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'coba?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'coba?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'coba';
            $config['first_url'] = base_url() . 'coba';
        }
    ...
    public function deletebulk(){
        $delete = $this->Coba_model->deletebulk();
        if($delete){
            $this->session->set_flashdata('message', 'Delete Record Success');
        }else{
  ...
  public function printdoc(){
        ...
        $this->load->view('coba/coba_print', $data);
    }
...
/* Generated by Harviacode Codeigniter CRUD Generator 2019-01-23 06:16:47 */
/* http://harviacode.com */