...
class Hutang extends CI_Controller {
	...
	public function index()
	{
		...
		$data['title'] = 'Penyewaan Properti - Hutang';
		$data['subtitle'] = '';
        $data['crumb'] = [
            'Sewa Properti' => '',
            'Hutang' => '',
		...
		$main->display("sewa_properti/hutang/index",$data);
	
	}


	function get_data_sp_hutang()
    {
    	$list = $this->dtable->get_datatables_sp_hutang();
		$data = array();
		$no = $_POST['start'];
		...
		$output = array(
			"draw" => $_POST['draw'],
			"recordsTotal" => $this->dtable->count_all_sp_hutang(),
			"recordsFiltered" => $this->dtable->count_filtered_sp_hutang(),
			"data" => $data,
		);
