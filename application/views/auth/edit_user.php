                    ...
                    <p>
                      <div class="form-group">
                        ...
                        <select class="form-control" name="role">
                          <option value="" <?php if($user->role == 0) echo "selected";?>></option>
                          <option value="1" <?php if($user->role == 1) echo "selected";?>>Administrator</option>
                          <option value="2" <?php if($user->role == 2) echo "selected";?>>Admin Investasi</option>
                          <option value="3" <?php if($user->role == 3) echo "selected";?>>Admin Sewa</option>
                        </select>
                      </div>
                    </p>
