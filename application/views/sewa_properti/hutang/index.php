            ...
            <div class="modal-dialog modal-lg">
               <div class="modal-content">
                   <div class="modal-header">
                       ...
                       <h4 class="modal-title" id="myModalLabel"><i class="fa fa-cubes"></i> <span id="text">Form Sewa Properti - Hutang</span></h4>
                   </div>
...
<script type="text/javascript">
    ...
    {      
            $.ajax({
                url: '<?php echo base_url();?>sewa_properti/hutang/getDetail/'+id,
                // data: data,
                method: 'POST',
                dataType: 'json',
                // crossDomain: true,
                ...
                success: function(result) {
                    ...
                    { 
                        ...
                        $("#text").text("Edit Sewa Properti - Hutang");
    ...
    function hapusData(){
        ...
        $.ajax({
            url : dns + 'sewa_properti/hutang/delete/'+idhps,
            type: 'POST',
            dataType: "JSON",
    ...
    $(document).ready(function() {
        ...
        $('#myModal').on('hidden.bs.modal', function () {
            ...
            $("#text").text("Form Sewa Properti - Hutang");
        ...
        table = $('#table').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo base_url()?>sewa_properti/hutang/get_data_sp_hutang",
                "type": "POST"
            },
    ...
    {   
            ...
            if($('#sewa_properti_id').val() != '') {
              var url = dns + 'sewa_properti/hutang/proses_edit';
              ...
              var url = dns + 'sewa_properti/hutang/proses_add';
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    if(result.code==0)
                    {
                        ...
                        setTimeout(function() {
                            location.href = '<?php echo base_url();?>sewa_properti/hutang/';
                        }, 1000);
