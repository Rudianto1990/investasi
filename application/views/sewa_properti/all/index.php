                ...
                <table class="table table-striped" id="table">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center" style="vertical-align: middle">Info Tagihan</th>
            ...
            <div class="modal-dialog modal-lg">
               <div class="modal-content">
                   <div class="modal-header">
                       ...
                       <h4 class="modal-title" id="myModalLabel"><i class="fa fa-cubes"></i> <span id="text">Form Sewa Properti - All</span></h4>
                   </div>
...
<script type="text/javascript">
    ...
    {      
            $.ajax({
                url: '<?php echo base_url();?>sewa_properti/all/getDetail/'+id,
                // data: data,
                method: 'POST',
                dataType: 'json',
                // crossDomain: true,
                ...
                success: function(result) {
                    ...
                    { 
                        ...
                        $("#text").text("Edit Sewa Properti - All");
    ...
    function hapusData(){
        ...
        $.ajax({
            url : dns + 'sewa_properti/all/delete/'+idhps,
            type: 'POST',
            dataType: "JSON",
    ...
    $(document).ready(function() {
        ...
        $('#myModal').on('hidden.bs.modal', function () {
            ...
            $("#text").text("Form Sewa Properti - All");
        ...
        table = $('#table').DataTable({ 
            ...
            "order": [], 
            "oLanguage": {
                "sProcessing": '<p style="color: blue"><i class="fa fa-spinner fa-spin fa-2x fa-fw"></i></p><span class="sr-only">Loading…</span>',
            },
            "ajax": {
                "url": "<?php echo base_url()?>sewa_properti/all/get_data_sp_all",
                "type": "POST"
            },
    ...
    {   
            ...
            if($('#sewa_properti_id').val() != '') {
              var url = dns + 'sewa_properti/all/proses_edit';
              ...
              var url = dns + 'sewa_properti/all/proses_add';
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    if(result.code==0)
                    {
                        ...
                        setTimeout(function() {
                            location.href = '<?php echo base_url();?>sewa_properti/all/';
                        }, 1000);
