          ...
          <div class="box box-default">
            ...
            <div class="box-body">
                ...
                <div class="text-center" style="margin-bottom: 20px;">
                  ...
                  <div style="font-weight: 600;font-size: 20px;">LAPORAN EXPLOITASI - IPC Pelabuhan II Kantor Cabang Priok</div>
                  <div style="font-size: 15px;">Alamat Kantor : Jl.Raya Pasoso Jakarta-Utara</div>
               ...
               <div class="table-responsive">
                 <table class="table table-bordered">
                   ...
                   <?php
                      ...
                      if($v->eksploitasi_selesai_pekerjaan != null)
                      {
                                ...
                                $selisih_hari = $tanggal2->diff($tanggal1)->format("%a"); //Untuk mengasilkan jumlah hari 

                                if($selisih_hari >= 30)
                                {
                                  // if($selisih_hari-= 0 && $selisih_hari->format("%r%a") <= 14)
                                  // {
                                  ...
                                  else
                                  {
                                    ...
                                    $indikator = "<span><i class='fa fa-circle' style='color:purple;'></i></span>"; // Nilai 0 hari yang artinya selesai masa kontrak
                                  }
                                }


                  /* BATASSSSSSSS By rudi
                      ...
                      Ini diblok saja else loop tsb dari tanggal 25/09/2019 jam 14:00 by rudi
                   ...
                   <tr>
                     ...
                     <td style="text-align: center;vertical-align: middle"><?php echo $v->eksploitasi_pr_number;?></td>
                     <td style="text-align: center;vertical-align: middle"><?php echo $v->eksploitasi_po_number;?></td>
                     <td style="text-align: center;vertical-align: middle"><?php echo $v->bidang_nama;?></td>
                     <td style="text-align: center;vertical-align: middle"><?php echo $v->eksploitasi_uraian_pekerjaan;?></td>
                     <td style="text-align: center;vertical-align: middle"><?php echo $v->eksploitasi_no_kontrak;?></td>
                     <td style="text-align: right;vertical-align: middle"><?php echo number_format($v->eksploitasi_nilai_pekerjaan,0,',','.');?></td>
                     <td style="text-align: center;vertical-align: middle"><?php echo date("d/m/Y", strtotime($v->eksploitasi_mulai_pelaksanaan));?></td>
                     <td style="text-align: center;vertical-align: middle"><?php echo date("d/m/Y", strtotime($v->eksploitasi_selesai_pekerjaan));?></td>
                     <td style="text-align: center;vertical-align: middle"><?php echo date("d/m/Y", strtotime($v->eksploitasi_tanggal_jaminan_pelaksanaan));?></td>
...
<script type="text/javascript">
   ...
   $( "#proses" ).click(function() {
        ...
        location.href= dns+ "laporan/laporan_eksploitasi/index?from="+from+"&to="+to;
    });
   ...
   $("#exportExcel").on("click",function(){
        ...
        location.href= dns+ "laporan/laporan_eksploitasi/export_excel?from="+from+"&to="+to;
  });
    ...
    $("#cetakPDF").on("click",function(){
        ...
        window.open(dns+ "laporan/laporan_eksploitasi/cetak_pdf?from="+from+"&to="+to);
    });
